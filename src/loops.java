public class loops {
    public static void main(String[] args){
        ...
        System.out.println("--------Fibonacci Sequence-------");            //Fibonacci Sequence  is a sequence where each number is the sum of the two preceding ones, usually starting from 0 and 1.
        System.out.println("------For Loop----->");                         // The sequence begins 0,1,1,2,3,4,5,8,13,21,34...and continues infinitely.
